        ...
        <div className="space-y-8">
          <div>
            ...
            <ul className="mt-3">
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    <svg
                      className={`shrink-0 fill-current ${pathname === "/" ? "text-blue-400" : "text-slate-500"}`}
              ...
              <li
                className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 ${
                  pathname.includes("labs") && "bg-blue-500/20"
                }`}
              >
                <NavLink
                  end
                ...
                >
                  <div className="flex items-center">
                    <svg
                      className={`shrink-0 fill-current ${pathname.includes("labs") ? "text-blue-400" : "text-slate-500"}`}
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
              ...
              <li
                className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 ${
                  pathname.includes("users") && "bg-blue-500/20"
                }`}
              >
                <NavLink
                  end
                ...
                >
                  <div className="flex items-center">
                    <svg
                      className={`shrink-0 fill-current ${pathname.includes("users") ? "text-blue-400" : "text-slate-500"}`}
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
              ...
              <li
                className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 ${
                  pathname.includes("reservations") && "bg-blue-500/20"
                }`}
              >
                <NavLink
                  end
                ...
                >
                  <div className="flex items-center">
                    <svg
                      className={`shrink-0 fill-current ${pathname.includes("reservations") ? "text-blue-400" : "text-slate-500"}`}
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
