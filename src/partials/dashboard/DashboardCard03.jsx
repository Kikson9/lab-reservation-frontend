      ...
      // Indigo line
      {
        ...
        backgroundColor: function (context) {
          ...
          return chartAreaGradient(ctx, chartArea, [
            {
              stop: 0,
              color: adjustColorOpacity(getCssVariable("--color-blue-600"), 0),
            },
            {
              stop: 1,
        ...
        borderColor: getCssVariable("--color-blue-600"),
        borderWidth: 2,
        pointRadius: 0,
        pointHoverRadius: 3,
        pointBackgroundColor: getCssVariable("--color-blue-600"),
        pointHoverBackgroundColor: getCssVariable("--color-blue-600"),
        pointBorderWidth: 0,
