        ...
        {submitted ? (
          ...
          <div className="text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">
              We've sent a password reset link to <span className="font-medium text-gray-700 dark:text-gray-300">{email}</span>. Check your inbox and follow the instructions.
            </p>
            <Link
              to="/login"
