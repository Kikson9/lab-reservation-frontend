      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg w-full max-w-md p-8">
        ...
        <div className="space-y-5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-2.5 bg-violet-500 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition duration-150"
          >
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
          ...
          <Link
            to="/login"
            className="text-violet-500 hover:text-blue-700 font-medium"
          >
            Sign in
          </Link>
        </p>
