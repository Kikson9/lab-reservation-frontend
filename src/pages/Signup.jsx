      ...
      <div className="hidden lg:flex lg:w-[46%] bg-[#0F172A] relative overflow-hidden flex-col p-11">
        ...
        <div className="relative z-10 my-auto">
          <h2 className="text-[27px] font-bold text-white leading-tight tracking-tight mb-3">
            Join thousands of
            <br />
            students <span className="text-blue-600">booking smarter.</span>
          </h2>
          <p className="text-slate-400 text-sm leading-relaxed max-w-[280px]">
            Create your account and start reserving lab seats instantly.
          </p>
        </div>
        ...
        <div className="w-full max-w-[330px] py-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold text-sm rounded-[9px] transition-all duration-150 hover:shadow-lg hover:shadow-blue-600/25 hover:-translate-y-px mt-1"
            >
              {loading ? (
