            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className={`w-full px-3.5 py-2.5 pr-10 border-[1.5px] rounded-[9px] text-sm bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-[3px] focus:ring-blue-600/10 focus:border-blue-600 focus:bg-white dark:focus:bg-gray-700 transition-all ${
                    errors.password
                      ? "border-red-400"
                      : "border-gray-200 dark:border-gray-700"
                  }`}
