...
const myReservations = [
  { id: 1, lab: 'Room 101', date: '2025-06-01', time: '09:00', status: 'Active' },
  { id: 2, lab: 'Room 203', date: '2025-06-03', time: '11:00', status: 'Pending' },
  { id: 3, lab: 'Room 305', date: '2025-05-19', time: '14:00', status: 'Cancelled' },
];
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      ...
      <div className="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <Link
          ...
          className="mt-4 sm:mt-0 inline-block px-5 py-2.5 bg-violet-500 hover:bg-violet-600 text-white text-sm font-semibold rounded-lg transition duration-150"
        >
          + Book a Seat
        </Link>
      </div>
        ...
        <div className="col-span-12 sm:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="w-8 h-8 bg-yellow-100 dark:bg-yellow-500/20 rounded-full flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="text-yellow-500" viewBox="0 0 16 16">
        ...
        <div className="col-span-12 sm:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="w-8 h-8 bg-violet-100 dark:bg-violet-500/20 rounded-full flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="text-violet-500" viewBox="0 0 16 16">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-xs rounded-xl mb-6">
        ...
        {upcoming.length === 0 ? (
          ...
          <div className="text-center py-10">
            ...
            <Link
              to="/student/browse-labs"
              className="inline-block px-5 py-2 bg-violet-500 hover:bg-violet-600 text-white text-sm font-semibold rounded-lg transition duration-150"
            >
              Browse Labs
            </Link>
          </div>
      ...
      {/* Quick action banner */}
      <div className="bg-violet-500 rounded-xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
        ...
        <Link
          to="/student/browse-labs"
          className="shrink-0 px-6 py-2.5 bg-white text-violet-600 hover:bg-violet-50 font-semibold text-sm rounded-lg transition duration-150"
        >
          Browse Labs
        </Link>
      </div>
